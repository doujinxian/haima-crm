...
public class ComplaintContentController {
	...
	public Result list(Integer page, Integer limit){
		...
		//查询列表数据
		List<ComplaintContentEntity> complaintContentList = complaintContentService.queryList(map);
	...
	public Result info(@PathVariable("id") Integer id){
		ComplaintContentEntity complaintContent = complaintContentService.queryObject(id);
	...
	@ResponseBody
	@RequestMapping("/save")
	public Result save(@RequestBody ComplaintContentEntity complaintContent){
	...
	public Result update(@RequestBody ComplaintContentEntity complaintContent){
